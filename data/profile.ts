...
export const experience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    source: "resume",
    bullets: [
      "Developed Resource platform for 15,000+ users across four colleges (React, Next.js, Tailwind, MongoDB, PostgreSQL), 4M+ page views and ~30 min average sessions.",
      "Implemented Scalable full-stack design with automated deploys: high-traffic content delivery and real-time engagement.",
    ],
  },
  {
